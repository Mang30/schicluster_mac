#!/bin/bash
# Processing script for 20-length chromosome contact table
...
# Run processing for this specific stage with 20-chromosome configuration
python3 scripts/process_hic_by_stage.py --specific_stage "$STAGE" \
    --chrom_size_file "mm10_chrom_sizes.txt" 2>&1 | tee "$LOG_DIR/processing_$STAGE.log"
