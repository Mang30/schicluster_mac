...
#SBATCH -o ../logs/pairs2h5ad/1chr_pairs2h5ad.%j.out       ## Job's standard output and error file
#SBATCH -J 1chr_pairs2h5ad              ## Job name
...
OUTPUT_DIR="/public/home/hpc254701055/Downloads/11pair2h5ad/output/h5ad_final_${RESOLUTION}/chr1.h5ad" # 确保输出是文件而不是目录
